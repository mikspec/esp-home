## Purpose
Define weak-section handling semantics for irrigation, including section classification, one global pre-charge duration, and staged startup behavior across both idle start and active transitions.
